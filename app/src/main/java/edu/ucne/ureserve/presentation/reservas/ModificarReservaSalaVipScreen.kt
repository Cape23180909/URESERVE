...
fun PreviewModificarReservaSalaVipScreen() {
    // Para preview, usamos un navController simulado o null-safe
    ModificarReservaSalaVipScreen(
        navController = rememberNavController() // Requiere importar androidx.navigation.compose.rememberNavController
    )
}
