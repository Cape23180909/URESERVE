...
@Composable
fun ConfirmacionReservaRestauranteScreen(
    ...
    Column(
        ...
        val terminos = listOf(
            ...
            "El costo es de 25,000. Las reservaciones se pueden agendar hasta con un día de antelación e incluso hasta con un año de antelación.",
            "Se pueden hacer siempre y cuando tengan el espacio disponible. Las reservas duran un día completo.",
            "El Restaurante cuenta con proyectores, pantalla de proyección, música, asientos y mesas.",
            "Este apartado cuenta con una capacidad máxima de 35 personas.",
